...
<div style="position:relative;" class="col-sm-4 col-md-3 col-lg-2 m-2 text-center bg-light">
	<?php
		...
		if($likes == 0)
			$likes = "";
	?>
	<div onclick="post.like('<?=$row->id?>',this)" class="heart p-2 bg-info border border-light" style="transition: all 0.3s cubic-bezier(.68,-0.55,.27,1.55);position: absolute;right: 10px;cursor: pointer;">
